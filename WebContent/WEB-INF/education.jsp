...
<body>
	...
	<table    cellpadding="0" cellspacing="0" id="tb" class="table table-striped" >
		...
		<c:forEach items="${education}" var="education"  varStatus="loop" >
	
		<tr>
		    <td>${education.education_college}</td>
			<td>${education.education_major}</td>
			 <td class="count1" >${education.education_graduate_count}</td> 
			<td class="count2">${education_gra[loop.count-1].education_employment_count}</td>
            <td><fmt:formatNumber type="number" value="${education_gra[loop.count-1].education_employment_count/ education.education_graduate_count*100} " maxFractionDigits="2"/>%</td>
      	</tr>
