...
<body>
	...
	<table    cellpadding="0" cellspacing="0" id="tb" class="table table-striped" >
		...
		<c:forEach items="${electricity}" var="electricity"  varStatus="loop" >
	
		<tr>
		    <td>${electricity.electricity_college}</td>
			<td>${electricity.electricity_major}</td>
			 <td class="count1" >${electricity.electricity_graduate_count}</td> 
			<td class="count2">${electricity_gra[loop.count-1].electricity_employment_count}</td>
            <td><fmt:formatNumber type="number" value="${electricity_gra[loop.count-1].electricity_employment_count/ electricity.electricity_graduate_count*100} " maxFractionDigits="2"/>%</td>
      	</tr>
